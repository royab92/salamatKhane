...
public class MyBuyActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SpannableString str = new SpannableString("درخواست های خرید داروخانه");
        ...
        ClickableSpan clickableSpan = new ClickableSpan() {
            ...
            public void onClick(View textView) {
                Intent i=new Intent(MyBuyActivity.this,BuyRequestActivity.class);
                startActivity(i);
            }
            @Override
        ...
        spanString.setSpan(clickableSpan, 0, 12, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        t1.setText(spanString);
        t1.setMovementMethod(LinkMovementMethod.getInstance());

        ReceiveRequests apg = new ReceiveRequests(MyBuyActivity.this);
        ...
        try {
            ...
            apg.DataRecieve(requestjo, new ReceiveRequests.Recieve() {
                ...
                public void onDataRecieve(ArrayList<Drug> drugs, int StatusCode, String Message) {
                  //  Toast.makeText(MyBuyActivity.this,String.valueOf(StatusCode),Toast.LENGTH_SHORT).show();
                    if (StatusCode == 0) {
                      //  Toast.makeText(MyBuyActivity.this,String.valueOf(drugs.size()),Toast.LENGTH_SHORT).show();
                        if(drugs.size()!=0){
                            int dsize=0;
                            for(int j=0;j<drugs.size();j++){
                              if(drugs.get(j).state.matches("ForBuy")){
                                  dsize=dsize+1;
                              }
                            }
                            if(dsize!=0){
                            ...
                            for(int i=0;i<drugs.size();i++) {
                                if (drugs.get(i).state.matches("ForBuy")) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent t=new Intent(MyBuyActivity.this,BuyRequestActivity.class);
                startActivity(t);
            }
        });
    ...
    public void clickitem(View v){
        ...
        switch (v.getId()) {
            case R.id.sellrequest: {
                drawer.closeDrawers();
                Intent intent=new Intent(MyBuyActivity.this,BuyActivity.class);
            ...
            case R.id.buyrequest: {
                drawer.closeDrawers();
                Intent intent=new Intent(MyBuyActivity.this,SellActivity.class);
                startActivity(intent);
                //your code.
            }
            break;
            case R.id.stsell: {
                drawer.closeDrawers();
                 Intent intent=new Intent(MyBuyActivity.this,MySellActivity.class);
                 startActivity(intent);
                //your code.
            }
            break;
            case R.id.stbuy: {
                drawer.closeDrawers();
                //   Intent intent=new Intent(BuyActivity.this,MyBuyActivity.class);
                // startActivity(intent);
                //your code.
            }
            break;
            ...
            case R.id.editstore: {
                drawer.closeDrawers();
                Toast.makeText(MyBuyActivity.this,"درخواست خود را ایمیل نمایید",Toast.LENGTH_SHORT).show();
                //your code.
            }
            break;
            case R.id.editinfo: {
                drawer.closeDrawers();
                Intent intent=new Intent(MyBuyActivity.this,EditInfoActivity.class);
                startActivity(intent);
            }
            break;
            case R.id.account: {
            ...
            case R.id.logout: {
                ...
                editor.apply();
                Intent intent=new Intent(MyBuyActivity.this,Main2Activity.class);
                startActivity(intent);
                finish();
                //your code.
            }
            ...
            case R.id.intro: {
                ...
                AlertDialog.Builder alertDialog = new AlertDialog.Builder(MyBuyActivity.this);
                alertDialog.setTitle("معرفی کارمندان");
                alertDialog.setMessage("شماره موبایل کارمند را وارد کنید:");
                final EditText input = new EditText(MyBuyActivity.this);
                        ...
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                if(input.getText().toString().matches("")){
                                    Toast.makeText(MyBuyActivity.this,"شماره ای وارد نشده است!",Toast.LENGTH_SHORT).show();
                                }else {
                                    Intro upd = new Intro(MyBuyActivity.this);
                                    JSONObject requestjo = new JSONObject();
                                    try {
                                        ...
                                        upd.introRecieve(requestjo, new Intro.intro() {
                                            ...
                                            public void onintro(int StatusCode, String Message) {
                                                ...
                                                if (StatusCode != 0) {
                                                    Toast.makeText(MyBuyActivity.this, Message, Toast.LENGTH_SHORT).show();
                                                    if(StatusCode==4){
                                                        AlertDialog.Builder builder;
                                                        builder = new AlertDialog.Builder(MyBuyActivity.this);
                                                        ...
                                                        Toast.makeText(MyBuyActivity.this, "عملیات موفق", Toast.LENGTH_SHORT).show();
                                                    }
                                                }
                                            }
                                        });
