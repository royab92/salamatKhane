...
public class RemoveReq {
    ...
    public RemoveReq(Context context){
        this.context=context;
    }
    public interface Update{
        void onUpdate(int StatusCode, String Message);
    }
    public void UpdateRecieve(JSONObject requestja, final RemoveReq.Update osc ){
        final JsonObjectRequest request=new JsonObjectRequest(Request.Method.POST,"Http://www.salamatkhane.com/api/RemoveRequest",requestja,new Response.Listener<JSONObject>() {
            @Override
