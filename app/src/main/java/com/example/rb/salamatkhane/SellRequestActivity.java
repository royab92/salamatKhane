...
public class SellRequestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SpannableString str = new SpannableString("ثبت درخواست فروش");
    ...
    public void clickSave(View v){
        ...
        builder = new AlertDialog.Builder(SellRequestActivity.this);
        builder.setTitle("")
                ...
                .setPositiveButton("بله، ذخیره شود", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if(!name.matches("")&&!cate.matches("")&&!company.matches("")&&!count.matches("")&&!unit.matches("")&&!mili.matches("")) {
                            RequestBS upd = new RequestBS(SellRequestActivity.this);
                            ...
                            try {
                                ...
                                requestjo.put("ExpireDate", expire);
                                ...
                                upd.RequestRecieve(requestjo, new RequestBS.Requestbs() {
                                    ...
                                    public void onRequest(int StatusCode, String Message) {
                                        ...
                                        if (StatusCode != 0) {
                                            Toast.makeText(SellRequestActivity.this, Message, Toast.LENGTH_SHORT).show();
                                        } else {

                                            Toast.makeText(SellRequestActivity.this, " ثبت موفقیت آمیز درخواست", Toast.LENGTH_SHORT).show();
                            ...
                            Toast.makeText(SellRequestActivity.this,"پر کردن تمام فیلدها الزامی است!",Toast.LENGTH_SHORT).show();
                        }
                    }
                })
                .setNegativeButton("خیر، حذف شود", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
Intent intent=new Intent(SellRequestActivity.this,SellRequestActivity.class);
                ...
                .setPositiveButton("دوربین", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        if (checkSelfPermission(Manifest.permission.CAMERA)
                            ...
                            ActivityCompat.requestPermissions(SellRequestActivity.this,new String[]{Manifest.permission.CAMERA},
...
byte[] value;
        if (requestCode == RESULT_LOAD_IMAGE && resultCode == RESULT_OK && null != data) {
            ...
            try{
            value=readBytes(imageUri);}catch (Exception e) {
                e.printStackTrace();
            }
