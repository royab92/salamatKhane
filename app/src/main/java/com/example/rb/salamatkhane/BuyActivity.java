...
public class BuyActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       final Typeface tf = Typeface.createFromAsset(getAssets(), "IRANSansMobile(FaNum).ttf");
        ...
        SpannableString str = new SpannableString("درخواست های فروش");
       ...
       // toolbar.setLogo(R.drawable.salamatkhanelogow);
        ...
        if(!pref.contains("changes")) {
            ...
            builder.setTitle("تغییرات نسخه ۱.۰.۱")
                    .setMessage("- رفع باگ های طراحی و منطقی برنامه" +"\n"
                    )
                    .setCancelable(false)
...
NavigationView view=(NavigationView)findViewById(R.id.nav_view);
      ...
      //  t5.setText("داروخانه");
        ...
        ClickableSpan clickableSpan = new ClickableSpan() {
            ...
            Intent i=new Intent(BuyActivity.this,BuyRequestActivity.class);
            startActivity(i);
            }
            @Override
      ...
      final  ReceiveDrug apg = new ReceiveDrug(BuyActivity.this);
        ...
        try {
            ...
            apg.DataRecieve(requestjo, new ReceiveDrug.Recieve() {
                ...
                public void onDataRecieve(final ArrayList<Drug> drugs, int StatusCode, String Message) {
                    //Toast.makeText(BuyActivity.this,apg.msg,Toast.LENGTH_SHORT).show();
                   // Toast.makeText(BuyActivity.this,String.valueOf(drugs.size()),Toast.LENGTH_SHORT).show();
                    if (StatusCode == 0) {
                       // Toast.makeText(BuyActivity.this,String.valueOf(drugs.size()),Toast.LENGTH_SHORT).show();
                        if(drugs.size()!=0){
                           ...
                           final String[] dnames=new String[drugs.size()];
                            ...
                            t5.setOnClickListener(new View.OnClickListener() {
                                @Override
                                public void onClick(View view) {
                                    final Dialog dialog = new Dialog(BuyActivity.this,R.style.Custom_Dialog);
                                   ...
                                   final ImageView tg3=(ImageView)dialog.findViewById(R.id.tg3);
                                    ...
                                    f5.addTextChangedListener(new TextWatcher() {
                                        ...
                                        public void onTextChanged(CharSequence s, int start, int before, int count) {
                                            ...
                                            if(s.length()>7){
                                            Toast.makeText(BuyActivity.this,"تاریخ وارد شده معتبر نیست!",Toast.LENGTH_SHORT).show();
                                            s=s.subSequence(0,7);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent t=new Intent(BuyActivity.this,BuyRequestActivity.class);
                startActivity(t);
            }
        });
    ...
    public void clickitem(View v){
        ...
        switch (v.getId()) {
            ...
            case R.id.editstore: {
                drawer.closeDrawers();
                Toast.makeText(BuyActivity.this,"درخواست خود را ایمیل نمایید",Toast.LENGTH_SHORT).show();
                //your code.
            }
            break;
            case R.id.editinfo: {
                drawer.closeDrawers();
                Intent intent=new Intent(BuyActivity.this,EditInfoActivity.class);
                startActivity(intent);
                //your code.
            }
            break;
            ...
            case R.id.logout: {
                ...
                editor.apply();
                Intent intent=new Intent(BuyActivity.this,Main2Activity.class);
                startActivity(intent);
                finish();
                //your code.
            }
            ...
            case R.id.intro: {
                ...
                final EditText input = new EditText(BuyActivity.this);
                        ...
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                if(input.getText().toString().matches("")){
                                    Toast.makeText(BuyActivity.this,"شماره ای وارد نشده است!",Toast.LENGTH_SHORT).show();
                                }else {
                                    Intro upd = new Intro(BuyActivity.this);
                                    JSONObject requestjo = new JSONObject();
                                    try {
                                            ...
                                            public void onintro(int StatusCode, String Message) {
                                                ...
                                                if (StatusCode != 0) {
                                                    ...
                                                    if(StatusCode==4){
                                                        ...
                                                        Toast.makeText(BuyActivity.this, "عملیات موفق", Toast.LENGTH_SHORT).show();
                                                    }
                                                }
                                            }
                                        });
